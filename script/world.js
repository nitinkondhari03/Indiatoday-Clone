...
//let api =  https://newsapi.org/v2/top-headlines?country=us&apiKey=c651b3a97285417587d0f71f16e42732

let main = async () => {
  try {
    let res = await fetch(
      `https://newsapi.org/v2/top-headlines?country=us&apiKey=c651b3a97285417587d0f71f16e42732&pageSize=10&page=1`
    );
